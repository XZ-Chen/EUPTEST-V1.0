...
void InjectorWide(uint16 nCycle,uint16 nWide) //喷射时间
{
    ...
    PITSetCycle(1,nCycle);     //开定时器1 时间 (周期) set PITMTLD
...
#pragma CODE_SEG DEFAULT
//PWMOutput(INJECTOR_PWM0,100);
      //PWMOutput(INJECTOR_PWM1,100);
      //PWMOutput(INJECTOR_PWM2,100);
      //PWMOutput(INJECTOR_PWM3,50);